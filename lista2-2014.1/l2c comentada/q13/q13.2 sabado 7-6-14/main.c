...
int main()
{
    ...
    if (ponteiro != NULL)
    {
        for (i=0 ; i<n ; i++)
        {
            ...
            vetor[elemento](&*ponteiro); //chamada das funcoes q o elemento diz qual operacaos sera feita. passa como parametro um ponteiro q aponta para estrutura(onde tem o x, y etc)
        }

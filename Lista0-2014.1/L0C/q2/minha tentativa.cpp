...
a=(int)n;  //convertendo um numero float a uma parte inteira, ele imprime so a parte inteira, ex: 3.2 ele imprime 3. "a" é a vriavel q vai guarar a parte float do n
